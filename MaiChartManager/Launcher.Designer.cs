...
partial class Launcher
{
    ...
    private void InitializeComponent()
    {
        ...
        textBox1.Location = new Point(200, 367);
        ...
        button1.Location = new Point(766, 367);
        button1.Margin = new Padding(4);
        button1.Name = "button1";
        button1.Size = new Size(237, 33);
        button1.TabIndex = 1;
        ...
        button2.Location = new Point(4, 45);
        button2.Margin = new Padding(4);
        button2.Name = "button2";
        button2.Size = new Size(237, 97);
        button2.TabIndex = 2;
        ...
        label1.Location = new Point(483, 404);
        label1.Margin = new Padding(4, 0, 4, 0);
        label1.Name = "label1";
        label1.Size = new Size(275, 194);
        label1.TabIndex = 5;
        ...
        tableLayoutPanel2.RowStyles.Add(new RowStyle(SizeType.Absolute, 363F));
        tableLayoutPanel2.RowStyles.Add(new RowStyle(SizeType.Absolute, 41F));
        tableLayoutPanel2.RowStyles.Add(new RowStyle(SizeType.Percent, 100F));
        tableLayoutPanel2.Size = new Size(1007, 598);
        ...
        label2.Location = new Point(4, 363);
        ...
        tableLayoutPanel3.Location = new Point(762, 452);
        ...
        tableLayoutPanel3.Size = new Size(245, 146);
        ...
        pictureBox1.Size = new Size(999, 355);
        ...
        flowLayoutPanel1.Location = new Point(196, 404);
        flowLayoutPanel1.Margin = new Padding(0);
        flowLayoutPanel1.Name = "flowLayoutPanel1";
        flowLayoutPanel1.Size = new Size(283, 194);
        ...
        checkBox_startup.Location = new Point(4, 39);
        checkBox_startup.Margin = new Padding(4);
        checkBox_startup.Name = "checkBox_startup";
        checkBox_startup.Size = new Size(149, 27);
        checkBox_startup.TabIndex = 2;
        checkBox_startup.Text = Locale.LauncherStartup;
        toolTip1.SetToolTip(checkBox_startup, Locale.LauncherOpenToLanDesc);
        ...
        checkBoxLanAuth.Location = new Point(4, 74);
        checkBoxLanAuth.Margin = new Padding(4);
        checkBoxLanAuth.Name = "checkBoxLanAuth";
        checkBoxLanAuth.Size = new Size(156, 27);
        ...
        // textBoxLanAuthUser
        // 
        textBoxLanAuthUser.Location = new Point(4, 109);
        textBoxLanAuthUser.Margin = new Padding(4);
        textBoxLanAuthUser.Name = "textBoxLanAuthUser";
        textBoxLanAuthUser.PlaceholderText = "用户名";
        textBoxLanAuthUser.Size = new Size(275, 30);
        textBoxLanAuthUser.TabIndex = 4;
        textBoxLanAuthUser.Visible = false;
        // 
        // textBoxLanAuthPass
        // 
        textBoxLanAuthPass.Location = new Point(4, 147);
        textBoxLanAuthPass.Margin = new Padding(4);
        textBoxLanAuthPass.Name = "textBoxLanAuthPass";
        textBoxLanAuthPass.PlaceholderText = "密码";
        textBoxLanAuthPass.Size = new Size(275, 30);
        ...
        tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Absolute, 35F));
        tableLayoutPanel1.Size = new Size(196, 194);
        ...
        label3.Location = new Point(4, 159);
        ...
        comboBox1.Items.AddRange(new object[] { "简体中文", "繁體中文", "English" });
        comboBox1.Location = new Point(3, 127);
